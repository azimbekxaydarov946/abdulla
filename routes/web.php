...
;
    ...
    Route::group([ 'middleware' => ['adminRole']], function () {
        ...
        Route::resource('evaluation', EvaluationController::class)->except('store', 'destroy', 'edit', 'update');
        Route::delete('evaluation/{id}', [EvaluationController::class, 'destroy'])->name('evaluationDestroy');
        Route::post('evaluation', [EvaluationController::class, 'store'])->name('evaluationStore');

        Route::get('evaluations/{id}', [EvaluationController::class, 'edit'])->name('evaluationEdit');
        Route::put('evaluations/{id}', [EvaluationController::class, 'update'])->name('evaluationUpdate');
